...
public class ResizeBDStrategyTest {
    ...
    private double maxx1, maxy1, maxx2, maxy2, maxx3, maxy3, maxx4, maxy4 = Math.random();

    @Before
    @Test
    public void setUp() {
        context1.setStrategy(new ResizeBDStrategy());
        context1.setContext(10.00, maxx1, 5.00, maxy1, 5.00, 10.00);
        context2.setStrategy(new ResizeBDStrategy());
        context2.setContext(15.00, maxx2, 5.00, maxy2, 110.00, 10.00);
        context3.setStrategy(new ResizeBDStrategy());
        context3.setContext(10.00, maxx3, 210.00, maxy3, 5.00, 25.00);
        context4.setStrategy(new ResizeBDStrategy());
        context4.setContext(35.00, maxx4, 310.00, maxy4, 35.00, 35.00);
    }
    ...
    public void testGetExclusivity() {
        assertEquals(1, context1.getExclusivity());
        assertEquals(1, context2.getExclusivity());
        assertEquals(1, context3.getExclusivity());
        assertEquals(1, context4.getExclusivity());
    }
