...
/**
 * Class to manage the creation of a tool for the creation of the rectangle
 * 
 */
public class RectangleTool extends Tool {
    ...
    public RectangleTool(Pane pane) {
        this.pane = pane;
    }
/**
    ...
    public void mouseUp(CanvasClass canvas, double x, double y) {
        ...
        canvas.createShape("rectangle", this.x, this.y, endX, endY, super.getInteriorColor(), super.getBorderColor());
    }
/**
