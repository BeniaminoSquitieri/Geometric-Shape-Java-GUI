...
/**
 * Concrete command for moving all selected shapes up a layer on the canvas.
 *
 */
public class SendForwardCommand extends Command {
     ...
     */
    public SendForwardCommand(CanvasClass app, Receiver receiver) {
        super(app, receiver);
    }
    ...
    public boolean execute() {
        ...
        int amount = shapesoncanvas.size();
